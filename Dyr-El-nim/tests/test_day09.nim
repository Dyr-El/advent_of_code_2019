...
suite "day09, problem 1":
    test "example 1":
        let
            ...
            expected:seq[int64] = @[109'i64,1'i64,204'i64,-1'i64,1001'i64,100'i64,1'i64,100'i64,1008'i64,
    ...
    test "example 2":
        let
            ...
            expected:seq[int64] = @[1219070632396864'i64]
        check(runProgram(input, @[]) == expected)
    test "example 3":
        let
            input = "104,1125899906842624,99"
            expected:seq[int64] = @[1125899906842624'i64]
        check(runProgram(input, @[]) == expected)
    test "solution":
        let
            input = open("inputs/day09.txt").readAll()
            expected:seq[int64] = @[sol1]
